...
lbox.grid(column=1, row=1, rowspan=5, columnspan=4, sticky=(N,S,E,W)) # add a widget to column 2
rowlabel.grid(column=1,row=0,pady=5)
lbl.grid(column=5, row=0, padx=10, pady=5)
g1.grid(column=5, row=1, sticky=W, padx=20)
g2.grid(column=5, row=2, sticky=W, padx=20)
g3.grid(column=5, row=3, sticky=W, padx=20)
send.grid(column=5, row=6, sticky=(W,E))
sentlbl.grid(column=5, row=5, columnspan=2, sticky=N, pady=5, padx=5)
status.grid(column=4, row=6, columnspan=2, sticky=(W,E))
